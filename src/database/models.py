...
class Customer(BaseModel):
    ...
    customer_segment: str = Field(..., description="Customer tier (Premium, Standard, Basic, VIP)")
...
class SalesTransaction(BaseModel):
    ...
    payment_method: str | None = Field(None, description="Payment type (may be NULL)")
    sales_channel: str = Field(..., description="Sales channel (Online, Store, Mobile, Phone)")
...
class DataQualityMetric(BaseModel):
    ...
    metric_name: str = Field(..., description="Metric type (completeness, accuracy, etc.)")
